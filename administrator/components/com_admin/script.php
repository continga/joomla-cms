...
class JoomlaInstallerScript
{
	...
	protected function uninstallRepeatableFieldsPlugin()
	{
		...
		try
		{
			// Start a transaction to could rollback if something happens
			$db->transactionStart();
			...
			// Execute the query and iterate over each `repeatable` instance
			foreach ($db->loadObjectList() as $row)
			{
				...
				if (isset($oldFieldparams->fields) && is_object($oldFieldparams->fields))
				{
					...
					// And now iterate over the sub fields
					foreach (get_object_vars($oldFieldparams->fields) as $oldField)
					{
						...
						// Try to save the new sub field in a loop to fix field name collisions
						while (true)
						{
							/**
							...
							// Try to save this, and do something when an error occurs
							if (!$fieldModel->save($data))
							{
								...
								if ($error == 'COM_FIELDS_ERROR_UNIQUE_NAME')
								{
									...
									// And start again with a new try to save it.
									continue 1;
								}

								// Else we don't know the error, so something is totally wrong. Bail out.
						...
						// And tell our new `subfields` field about his new child
	...
	public function deleteUnexistingFiles()
	{
		$files = array(
			...
			'/administrator/components/com_search/views/searches/tmpl/default.xml',
			...
			'/installation/application/bootstrap.php',
			'/installation/application/defines.php',
			'/installation/application/framework.php',
			'/installation/application/router.php',
			'/installation/application/web.php',
			'/installation/controller/database.php',
			'/installation/controller/default.php',
			'/installation/controller/detectftproot.php',
			'/installation/controller/ftp.php',
			'/installation/controller/install/config.php',
			'/installation/controller/install/database.php',
			'/installation/controller/install/database_backup.php',
			'/installation/controller/install/database_remove.php',
			'/installation/controller/install/email.php',
			'/installation/controller/install/languages.php',
			'/installation/controller/install/sample.php',
			'/installation/controller/preinstall.php',
			'/installation/controller/removefolder.php',
			'/installation/controller/setdefaultlanguage.php',
			'/installation/controller/setlanguage.php',
			'/installation/controller/site.php',
			'/installation/controller/summary.php',
			'/installation/controller/verifyftpsettings.php',
			...
			'/installation/language/af-ZA/af-ZA.ini',
			'/installation/language/af-ZA/af-ZA.xml',
			'/installation/language/ar-AA/ar-AA.ini',
			'/installation/language/ar-AA/ar-AA.xml',
			'/installation/language/be-BY/be-BY.ini',
			'/installation/language/be-BY/be-BY.xml',
			'/installation/language/bg-BG/bg-BG.ini',
			'/installation/language/bg-BG/bg-BG.xml',
			'/installation/language/bn-BD/bn-BD.ini',
			'/installation/language/bn-BD/bn-BD.xml',
			'/installation/language/bs-BA/bs-BA.ini',
			'/installation/language/bs-BA/bs-BA.xml',
			'/installation/language/ca-ES/ca-ES.ini',
			'/installation/language/ca-ES/ca-ES.xml',
			'/installation/language/ckb-IQ/ckb-IQ.ini',
			'/installation/language/ckb-IQ/ckb-IQ.xml',
			'/installation/language/cs-CZ/cs-CZ.ini',
			'/installation/language/cs-CZ/cs-CZ.xml',
			'/installation/language/cy-GB/cy-GB.ini',
			'/installation/language/cy-GB/cy-GB.xml',
			'/installation/language/da-DK/da-DK.ini',
			'/installation/language/da-DK/da-DK.xml',
			'/installation/language/de-AT/de-AT.ini',
			'/installation/language/de-AT/de-AT.xml',
			'/installation/language/de-CH/de-CH.ini',
			...
			'/installation/language/dz-BT/dz-BT.ini',
			...
			'/installation/language/eo-XX/eo-XX.xml',
			'/installation/language/es-CO/es-CO.ini',
			'/installation/language/es-CO/es-CO.xml',
			'/installation/language/es-ES/es-ES.ini',
			'/installation/language/es-ES/es-ES.xml',
			'/installation/language/et-EE/et-EE.ini',
			'/installation/language/et-EE/et-EE.xml',
			'/installation/language/eu-ES/eu-ES.ini',
			'/installation/language/eu-ES/eu-ES.xml',
			'/installation/language/fa-IR/fa-IR.ini',
			'/installation/language/fa-IR/fa-IR.xml',
			'/installation/language/fi-FI/fi-FI.ini',
			...
			'/installation/language/ro-RO/ro-RO.ini',
			'/installation/language/ro-RO/ro-RO.xml',
			'/installation/language/ru-RU/ru-RU.ini',
			'/installation/language/ru-RU/ru-RU.xml',
			'/installation/language/si-LK/si-LK.ini',
			'/installation/language/si-LK/si-LK.xml',
			'/installation/language/sk-SK/sk-SK.ini',
			'/installation/language/sk-SK/sk-SK.xml',
			'/installation/language/sl-SI/sl-SI.ini',
			'/installation/language/sl-SI/sl-SI.xml',
			'/installation/language/sr-RS/sr-RS.ini',
			...
			'/installation/language/srp-ME/srp-ME.xml',
			'/installation/language/sv-SE/sv-SE.ini',
			'/installation/language/sv-SE/sv-SE.xml',
			'/installation/language/sw-KE/sw-KE.ini',
			'/installation/language/sw-KE/sw-KE.xml',
			'/installation/language/sy-IQ/sy-IQ.ini',
			'/installation/language/sy-IQ/sy-IQ.xml',
			'/installation/language/ta-IN/ta-IN.ini',
			'/installation/language/ta-IN/ta-IN.xml',
			'/installation/language/th-TH/th-TH.ini',
			'/installation/language/th-TH/th-TH.xml',
			'/installation/language/tk-TM/tk-TM.ini',
			'/installation/language/tk-TM/tk-TM.xml',
			'/installation/language/tr-TR/tr-TR.ini',
			'/installation/language/tr-TR/tr-TR.xml',
			'/installation/language/ug-CN/ug-CN.ini',
			'/installation/language/ug-CN/ug-CN.xml',
			'/installation/language/uk-UA/uk-UA.ini',
			'/installation/language/uk-UA/uk-UA.xml',
			'/installation/language/vi-VN/vi-VN.ini',
			'/installation/language/vi-VN/vi-VN.xml',
			'/installation/language/zh-CN/zh-CN.ini',
			'/installation/language/zh-CN/zh-CN.xml',
			'/installation/language/zh-TW/zh-TW.ini',
			...
			'/installation/model/forms/defaultlanguage.xml',
			'/installation/model/forms/ftp.xml',
			'/installation/model/forms/preinstall.xml',
			'/installation/model/forms/site.xml',
			'/installation/model/forms/summary.xml',
			'/installation/model/ftp.php',
			'/installation/model/languages.php',
			'/installation/model/setup.php',
			'/installation/response/json.php',
			'/installation/sql/mysql/sample_blog.sql',
			'/installation/sql/mysql/sample_brochure.sql',
			'/installation/sql/mysql/sample_data.sql',
			'/installation/sql/mysql/sample_learn.sql',
			'/installation/sql/postgresql/sample_blog.sql',
			'/installation/sql/postgresql/sample_brochure.sql',
			'/installation/sql/postgresql/sample_data.sql',
			'/installation/sql/postgresql/sample_learn.sql',
			'/installation/sql/sqlazure/joomla.sql',
			'/installation/sql/sqlazure/sample_blog.sql',
			'/installation/sql/sqlazure/sample_brochure.sql',
			'/installation/sql/sqlazure/sample_data.sql',
			'/installation/sql/sqlazure/sample_learn.sql',
			'/installation/template/css/template_rtl.css',
			'/installation/template/js/installation.js',
			'/installation/view/complete/html.php',
			'/installation/view/complete/tmpl/default.php',
			'/installation/view/database/tmpl/default.php',
			'/installation/view/default.php',
			'/installation/view/defaultlanguage/html.php',
			'/installation/view/defaultlanguage/tmpl/default.php',
			'/installation/view/ftp/tmpl/default.php',
			'/installation/view/install/html.php',
			'/installation/view/install/tmpl/default.php',
			'/installation/view/languages/html.php',
			'/installation/view/languages/tmpl/default.php',
			'/installation/view/preinstall/html.php',
			...
			'/installation/view/summary/html.php',
		...
		$folders = array(
			...
			'/administrator/components/com_search/controllers',
			'/administrator/components/com_search/helpers',
			'/administrator/components/com_search/models',
			'/administrator/components/com_search/models/forms',
			'/administrator/components/com_search/views',
			'/administrator/components/com_search/views/searches',
			'/administrator/components/com_search/views/searches/tmpl',
			...
			'/installation/form/rule',
			'/installation/helper',
			'/installation/html',
			'/installation/language/af-ZA',
			'/installation/language/ar-AA',
			'/installation/language/be-BY',
			'/installation/language/bg-BG',
			'/installation/language/bn-BD',
			'/installation/language/bs-BA',
			'/installation/language/ca-ES',
			'/installation/language/ckb-IQ',
			'/installation/language/cs-CZ',
			'/installation/language/cy-GB',
			'/installation/language/da-DK',
			'/installation/language/de-AT',
			'/installation/language/de-CH',
			'/installation/language/de-DE',
			'/installation/language/de-LI',
			'/installation/language/de-LU',
			'/installation/language/dz-BT',
			'/installation/language/el-GR',
			'/installation/language/en-AU',
			'/installation/language/en-CA',
			'/installation/language/en-NZ',
			'/installation/language/eo-XX',
			'/installation/language/es-CO',
			'/installation/language/es-ES',
			'/installation/language/et-EE',
			'/installation/language/eu-ES',
			'/installation/language/fa-IR',
			'/installation/language/fi-FI',
			'/installation/language/fr-CA',
			'/installation/language/fr-FR',
			'/installation/language/ga-IE',
			'/installation/language/gl-ES',
			'/installation/language/he-IL',
			'/installation/language/hi-IN',
			'/installation/language/hr-HR',
			'/installation/language/hu-HU',
			'/installation/language/hy-AM',
			'/installation/language/id-ID',
			'/installation/language/it-IT',
			'/installation/language/ja-JP',
			'/installation/language/ka-GE',
			'/installation/language/kk-KZ',
			'/installation/language/km-KH',
			'/installation/language/ko-KR',
			'/installation/language/lt-LT',
			'/installation/language/lv-LV',
			'/installation/language/mk-MK',
			'/installation/language/ms-MY',
			'/installation/language/nb-NO',
			'/installation/language/nl-NL',
			'/installation/language/nn-NO',
			'/installation/language/pl-PL',
			'/installation/language/prs-AF',
			'/installation/language/pt-BR',
			'/installation/language/pt-PT',
			'/installation/language/ro-RO',
			'/installation/language/ru-RU',
			'/installation/language/si-LK',
			'/installation/language/sk-SK',
			'/installation/language/sl-SI',
			'/installation/language/sr-RS',
			'/installation/language/sr-YU',
			'/installation/language/srp-ME',
			'/installation/language/sv-SE',
			'/installation/language/sw-KE',
			'/installation/language/sy-IQ',
			'/installation/language/ta-IN',
			'/installation/language/th-TH',
			'/installation/language/tk-TM',
			'/installation/language/tr-TR',
			'/installation/language/ug-CN',
			'/installation/language/uk-UA',
			'/installation/language/vi-VN',
			'/installation/language/zh-CN',
			'/installation/language/zh-TW',
			'/installation/model',
			'/installation/model/forms',
			'/installation/response',
			'/installation/sql/sqlazure',
			'/installation/view',
			'/installation/view/complete',
			'/installation/view/complete/tmpl',
			'/installation/view/database',
			'/installation/view/database/tmpl',
			'/installation/view/defaultlanguage',
			'/installation/view/defaultlanguage/tmpl',
			'/installation/view/ftp',
			'/installation/view/ftp/tmpl',
			'/installation/view/install',
			'/installation/view/install/tmpl',
			'/installation/view/languages',
			'/installation/view/languages/tmpl',
			'/installation/view/preinstall',
			'/installation/view/preinstall/tmpl',
			'/installation/view/remove',
			'/installation/view/remove/tmpl',
			'/installation/view/site',
			'/installation/view/site/tmpl',
			'/installation/view/summary',
			'/installation/view/summary/tmpl',
